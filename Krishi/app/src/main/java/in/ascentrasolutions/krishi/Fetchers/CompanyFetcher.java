...
public class CompanyFetcher {
    ...
    public CompanyFetcher(ArrayList<Company> companyList, CompanyAdapter adapter) {
        ...
        if(result != null) {
            ...
            try {
                ...
                for (int i = 0; i <jsonArray.length(); i++) {
                    ...
                    companyList.add(new Company(company_image, company_location,  company_name, company_number));
