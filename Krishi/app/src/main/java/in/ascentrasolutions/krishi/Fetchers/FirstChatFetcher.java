...
public class FirstChatFetcher {

    private final ArrayList<Interactors> list;
    private final InteractorAdapter adapter;

    public FirstChatFetcher(ArrayList<Interactors> list, InteractorAdapter adapter) {
        ...
        if(result != null) {
            try {
                ...
                for (int i = 0; i <jsonArray.length(); i++) {
                    ...
                    String user_id = interactors.getString("chat_id");
