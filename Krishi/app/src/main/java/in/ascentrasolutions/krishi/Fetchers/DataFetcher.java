...
public class DataFetcher {
    ...
    private final TextView info, grow, duration;
    public DataFetcher(TextView info, TextView grow, TextView duration) {
        ...
        if(result != null) {
            try {
                ...
                for (int i = 0; i< jsonArray.length(); i++) {
                    ...
                    grow.setText(jsonObject.getString("grow"));
                    duration.setText(jsonObject.getString("grow_duration"));
